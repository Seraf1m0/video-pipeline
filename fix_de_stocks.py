"""
DE stock replacement + Grok regen для плохих видео.
...
SESSION  = "Video_20260315_203938"
VIDEOS   = BASE / "data/channels/de/media" / SESSION / "videos"
PROMPTS  = BASE / "data/channels/de/prompts" / SESSION / "video"
REPORT   = BASE / "data/channels/de/media"   / SESSION / "blip_report.json"
...
tr_file = BASE / "data/channels/de/transcripts" / SESSION / "result.json"
seg_map = {}
if tr_file.exists():
...
if to_regen:
    print(f"\n🚀 Запускаю Grok регенерацию для {len(to_regen)} видео...")
